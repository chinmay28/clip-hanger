 ...
 * how the app is deployed, and there is no second round trip before the mark
 * is drawn.
 *
 * The face is optional: web/fonts/wordmark-script.woff2 is a few glyphs of an
 * open-licensed script, cut down by scripts/make-wordmark-font.py. With no
 * file present the wordmark falls back to the platform's own handwriting face
 * and nothing breaks. See the README beside the fonts.
 */
